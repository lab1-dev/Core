...
To facilitate the creation of layouts, conventional [Bootstrap-like grids](https://getbootstrap.com/docs/4.0/layout/grid/) can be used through the [Grid](https://lab1.dev/grid) material component or through the [AnchorsLayout](https://lab1.dev/anchors), [RowLayout](https://lab1.dev/row-layout), [ColumnLayout](https://lab1.dev/column-layout) and [GridLayout](https://lab1.dev/grid-layout) components. Date and time management, on the other hand, can be easily done through the [DateTime](https://lab1.dev/date-time) and [TimeSpan](https://lab1.dev/time-span) classes.
